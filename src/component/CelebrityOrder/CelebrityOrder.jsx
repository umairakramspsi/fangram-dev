...
const CelebrityOrder = () => {
  ...
  return (
    <div className="main-celebrityorder">
           ...
           {screenWidth > 580 ?(<><div className="subs-plan-btns">
            ...
            <div className="secured-payment">
              <div className="payment-verified">
                Secured & safe payments <img src={verifiedLogo} />
              </div>
              <div className="payment-verified">
                Need help? Text Us <img src={helpIcon} />
              </div>
            </div></>):("")}
